    ...
    <ButtonsContainer>
        ...
        <LeftContent>
          <TextContent>
            <Flex>
              ...
              <Title>여기닷에게 문의하기</Title>
            </Flex>

            <Description>
              대표님의 예산에 맞춘 기능들을 견적으로 <br />
              자세히 받아보세요 ~ 등등
            </Description>
          </TextContent>
        </LeftContent>
        ...
        <LeftContent>
          <TextContent>
            <Flex>
              <IconWrapper>
                <Icon
                  src="/ai-estimate/trending_down.png"
                  width={24}
                  height={24}
                />
              </IconWrapper>
      ...
      >
        ...
        <Form onSubmit={handleSubmit}>
          ...
          />
          <Disclaimer>
            문의 시 개인정보 수집·이용에 동의한 것으로 간주됩니다.
          </Disclaimer>
