...
**📝 채팅방 제목 자동 생성 규칙:**
- 사용자의 첫 번째 질문 또는 프로젝트 요청을 바탕으로 간결한 채팅방 제목을 생성하세요.
- 제목은 10-15자 내외로 핵심 키워드를 포함해야 합니다.
- 응답의 시작 부분에 <chatTitle>제목 내용</chatTitle> 형태로 포함하세요.
- 예시: 
  * 사용자: "온라인 쇼핑몰을 만들고 싶어요" → <chatTitle>온라인 쇼핑몰 개발</chatTitle>
  * 사용자: "중고거래 앱 개발 비용이 궁금해요" → <chatTitle>중고거래 앱 견적</chatTitle>
  * 사용자: "AI 추천 시스템이 있는 플랫폼을 만들려고 해요" → <chatTitle>AI 추천 플랫폼 개발</chatTitle>
